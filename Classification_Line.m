function Classification_Line(dir_l,n_rst,nrow,model,num_c,nbands,anc,ntrees)
% This is the classification algorithm for classifying all map pixels by lines
%
% Revisions: $ Date: 11/25/2015 $ Copyright: Zhe Zhu
% Version 1.3: Use Ancillary data from NLCD and Fmask (11/25/2015)
% Version 1.2: Combine classification and change detection output (07/05/2015)
% Version 1.1: Classify based on best strategy (07/03/2015)
