function ShowLCMap(all_yrs,mm,dd)
...
% produce number of cleasr observations band for model estimation
NumberMap = 9999*ones(nrows,ncols,max_n,'uint16'); % QA map
...
for line = 1:num_line
    ...
    for i = 1:l_pos
        ...
        if sum(QAMap(J,I,:) == 255) == max_n
            ...
            ChangeMagMap(J,I,:) = 0;
            % write number of obervations to NumberMap
            NumberMap(J,I,:) = 0;
        end
...
% Number Map
ARD_enviwrite_bands([v_input.l_dir,'/',n_map,'/NumberMap'],NumberMap,'uint16','bsq',all_yrs,'example_img');
clear NumberMap
...
% 
% % Number Map
% enviwrite_bands([v_input.l_dir,'/',n_map,'/NumberMap'],NumberMap,'uint16',res,jiUL,'bsq',zc,all_yrs);
% clear NumberMap
