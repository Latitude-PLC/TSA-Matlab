...
% write ENVI files
% confirmed change
enviwrite([v_input.l_dir,'/',n_map,'/ChangeNumber'],ChangeNum,'uint8',res,jiUL,'bsq',zc);
enviwrite([v_input.l_dir,'/',n_map,'/ChangeYear'],ChangeTime,'single',res,jiUL,'bsq',zc);
enviwrite([v_input.l_dir,'/',n_map,'/ChangeMagnitude'],ChangeMag,'single',res,jiUL,'bsq',zc);
% 
