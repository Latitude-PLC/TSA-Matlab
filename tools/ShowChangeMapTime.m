...
% modify to Julian date
t_jd = datenum(yy,mm,dd);
...
% write ENVI files
% confirmed change
enviwrite([v_input.l_dir,'/',n_map,'/ChangeNum','_',num2str(yy),'_',num2str(mm),'_',num2str(dd)],ChangeNum,'uint8',res,jiUL,'bsq',zc);
% enviwrite([v_input.l_dir,'/',n_map,'/ChangeTime.100.6'],ChangeTime,'single',res,jiUL,'bsq',zc);
