function rec_cg = TrendSeasonalFit_v13Plot(N_row,N_col,T_cg,conse,B_detect)
% function rec_cg = TrendSeasonalFit_v13Plot(3845,2918,0.99,6,2:6);
% CCDC 13.11 version - Zhe Zhu, EROS, USGS
...
pause;
close all;
fprintf('CCDC v13.11 Testing Plots!\n');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%end of plot
% end of function
end