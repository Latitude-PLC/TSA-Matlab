function class_standalone(task,ntasks)
...
main_ClassificationPar1_4(task,ntasks) % with ANC & class by year
% main_ClassificationPar1_2(task,ntasks) % with ANC
% main_ClassificationPar1_1(task,ntasks) % without ANC
