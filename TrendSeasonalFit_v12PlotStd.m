function rec_cg = TrendSeasonalFit_v12PlotStd(N_row,N_col,T_cg,conse,B_detect)
...
line_t = zeros(num_t,nbands+3); %Ys
...
for i=1:num_t
    ...
    line_t(i,nbands+1:end) = fread(fid_t,3,'uint16=>double','ieee-le'); % get Ys
